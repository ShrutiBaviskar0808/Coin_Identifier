...
import 'investment_tips_screen.dart';
...
class _HomeContent extends StatelessWidget {
  ...
  Widget _buildQuickActions(BuildContext context) {
    final actions = [
      ...
      {'icon': Icons.verified_user, 'title': 'Authentication', 'screen': const AuthenticationScreen(), 'colors': [Color(0xFFff9a56), Color(0xFFff6a88)]},
      {'icon': Icons.compare_arrows, 'title': 'Compare', 'screen': const CompareScreen(), 'colors': [Color(0xFF8EC5FC), Color(0xFFE0C3FC)]},
      {'icon': Icons.lightbulb, 'title': 'Investment', 'screen': const InvestmentTipsScreen(), 'colors': [Color(0xFFfbc2eb), Color(0xFFa6c1ee)]},
    ];
